...
Window for setting up truck information for the app.

#### Enable Truck Entry

Enable truck entry to display truck selection towards the end of tracking rescue time in time window.

#### Truck Default

Select the default truck to be selected during the truck entry.

#### Truck Information

Setup all of the trucks that can be used for a selection.
Tap on the blue button to add a truck to the truck selection.
Hold and swipe left on record to display edit and delete options of truck selection.
...
Allows for different ways to promote our app to others

#### Send Feedback

Allows for feedback to be sent to us. Feel free to leave a comment, feedback, or suggestions about the app.

#### Leave review on App Store/Google Play Store

Depending on the phone, it will open Apple App Store or Google Play Console of the app.
