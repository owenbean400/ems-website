...
# Login Screen (Is being worked onto)

The login screen is not available as servers is needed to be built.
First screen to be seen by the user.
This screen allows the user to login or continue on in offline mode.
...
The 4 digit town ID is the 4 digit identification number assigned by the State. This ID is used to link to the records of the town.
