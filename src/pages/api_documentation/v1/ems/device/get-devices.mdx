---
title: Get Devices
path: /api_documentation/v1/ems/device/get-devices.mdx
date: 2025-02-15
---
...
Gets a list of devices of user through paging. Pagination allow for smaller set of data to be sent over through the api that helps prevent huge data transfer over the network.
...
| Query Parameters | |
| ---- | ----- |
| pageNumber | The page number of fetching device records. Must be an integer greater than 0. Default value to first page. |
...
The devices has been successfully fetched.
