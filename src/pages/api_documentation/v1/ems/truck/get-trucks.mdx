---
title: Get Trucks by ID
path: /api_documentation/v1/ems/get-trucks.mdx
date: 2025-02-15
---
...
Gets a list of trucks through paging. Pagination allow for smaller set of data to be sent over through the api that helps prevent huge data transfer over the network.
...
The trucks has been successfully fetched.
